                ...
                >
                  <div className="flex items-center mb-2">
                    <span className="mr-2 flex items-center justify-center" style={{ width: 12, height: 12, position: 'relative' }}>
                      <span
                        className="block w-3 h-3 rounded-full bg-red-500 dark:bg-red-400 border-2 border-red-500 dark:border-red-400 shadow-lg"
                        style={{
                    ...
                    <span
                      className="text-gray-700 dark:text-cyan-300 font-semibold text-xs uppercase tracking-wider ml-1"
                      style={{ border: 'none', outline: 'none', boxShadow: 'none', background: 'none' }}
                    >
                      CRICKET
                    </span>
                  </div>
                  <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-1 truncate group-hover:underline transition-all duration-200 drop-shadow-lg">{item.title}</h3>
                  <p className="text-gray-600 dark:text-white/80 text-sm truncate mb-2">{item.contentSnippet || item.content || item.summary || ''}</p>
                  <a
                    href={item.link}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="mt-4 px-4 py-2 bg-red-600 hover:bg-red-700 dark:bg-gradient-to-r dark:from-blue-600 dark:via-cyan-400 dark:to-blue-600 dark:hover:from-blue-700 dark:hover:to-blue-700 text-white rounded-full font-semibold shadow transition-all text-center relative shimmer-btn-glass"
                  >
